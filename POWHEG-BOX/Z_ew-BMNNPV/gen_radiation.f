...
c massive emitter
         ...
         pwhg_upperb_rad = pwhg_upperb_rad * ph_alphaem
      endif
      end
...
c see section 4 in ZZ paper, last paragraph
      ...
      xlr=0
 1    continue
c restore csimax; in case of massive emitter it may
c be altered in a vetoed call
      kn_csimax=kn_csimax_arr(kn_emitter)
      xlr=xlr+log(random())
c CERNLIB voodoo:
      call KERSET('C205. ',0,0,101)
