...
c over the two possible colour connections.
      ...
      if(colin(1).eq.0.and.colin(2).eq.0.and.fl2+fl3.eq.0) then
c This must be a photon
         if(fl2.gt.0) then
            colout2(1)=newcolor
            colout2(2)=0
            colout3(1)=0
      ...
      elseif(abs(fl2).eq.22) then
            colout3(1)=colin(2)
            colout3(2)=colin(1)
            colout2(1)=0
            colout2(2)=0
      elseif(abs(fl3).eq.22) then
            colout2(1)=colin(2)
            colout2(2)=colin(1)
            colout3(1)=0
            colout3(2)=0
      elseif(colin(1).ne.0.and.colin(2).ne.0) then
