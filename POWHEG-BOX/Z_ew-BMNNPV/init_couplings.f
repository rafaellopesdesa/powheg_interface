...
c rclsa      if (ph_alphaem.le.0d0) ph_alphaem = 1d0/137.03599911d0
...
c rclsa      if (ph_Zwidth.le.0d0) ph_Zwidth =  2.4924d0
      if (ph_Zwidth.le.0d0) ph_Zwidth =  2.4952d0

      ph_Wmass = powheginput("#Wmass")
c rclsa      if (ph_Wmass.le.0d0) ph_Wmass  = 80.37399d0     
      if (ph_Wmass.le.0d0) ph_Wmass  = 80.398d0     
      ph_Wwidth = powheginput("#Wwidth")
c rclsa      if (ph_Wwidth.le.0d0) ph_Wwidth =  2.0836d0
