...
C ***************************************************************** C
C - DGAUSS integration routine from cernlib ( not sure precisely  - C
C - where I got it anymore).                                      - C
C ***************************************************************** C
*
* $Id: setlocalscales.f,v 1.1.1.1 2013/02/15 23:10:29 rclsa Exp $
*
* $Log: setlocalscales.f,v $
* Revision 1.1.1.1  2013/02/15 23:10:29  rclsa
* creation of wmass_powheg_interface
*
